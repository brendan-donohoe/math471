...
program homework7
  ...
  integer, parameter :: nsteps = 1000 !1000 !Check at t = 0.8: Prev value: ~-15 compared to -0.72
  ...
  !call MPI_BARRIER(MPI_COMM_WORLD,ierr)
  ! send to the up recieve from the down
  call MPI_Sendrecv(xr(0:nrl+1,1),nrl+2,MPI_DOUBLE_PRECISION,p_up,227,&
       xr(0:nrl+1,nsl+1),nrl+2,MPI_DOUBLE_PRECISION,p_down,227,MPI_COMM_WORLD,status,ierr)
  call MPI_Sendrecv(yr(0:nrl+1,1),nrl+2,MPI_DOUBLE_PRECISION,p_up,228,&
       yr(0:nrl+1,nsl+1),nrl+2,MPI_DOUBLE_PRECISION,p_down,228,MPI_COMM_WORLD,status,ierr)
  ! send to the down recieve from the up
  call MPI_Sendrecv(xr(0:nrl+1,nsl),nrl+2,MPI_DOUBLE_PRECISION,p_down,229,&
       xr(0:nrl+1,0),nrl+2,MPI_DOUBLE_PRECISION,p_up,229,MPI_COMM_WORLD,status,ierr)
  call MPI_Sendrecv(yr(0:nrl+1,nsl),nrl+2,MPI_DOUBLE_PRECISION,p_down,230,&
       yr(0:nrl+1,0),nrl+2,MPI_DOUBLE_PRECISION,p_up,230,MPI_COMM_WORLD,status,ierr)
  ! send to the up recieve from the down
  call MPI_Sendrecv(xs(0:nrl+1,1),nrl+2,MPI_DOUBLE_PRECISION,p_up,327,&
       xs(0:nrl+1,nsl+1),nrl+2,MPI_DOUBLE_PRECISION,p_down,327,MPI_COMM_WORLD,status,ierr)
  call MPI_Sendrecv(ys(0:nrl+1,1),nrl+2,MPI_DOUBLE_PRECISION,p_up,328,&
       ys(0:nrl+1,nsl+1),nrl+2,MPI_DOUBLE_PRECISION,p_down,328,MPI_COMM_WORLD,status,ierr)
  ! send to the down recieve from the up
  call MPI_Sendrecv(xs(0:nrl+1,nsl),nrl+2,MPI_DOUBLE_PRECISION,p_down,329,&
       xs(0:nrl+1,0),nrl+2,MPI_DOUBLE_PRECISION,p_up,329,MPI_COMM_WORLD,status,ierr)
  call MPI_Sendrecv(ys(0:nrl+1,nsl),nrl+2,MPI_DOUBLE_PRECISION,p_down,330,&
       ys(0:nrl+1,0),nrl+2,MPI_DOUBLE_PRECISION,p_up,330,MPI_COMM_WORLD,status,ierr)
  call MPI_BARRIER(MPI_COMM_WORLD,ierr)
  ...
  !call MPI_BARRIER(MPI_COMM_WORLD,ierr)
  ! send to the up recieve from the down
  call MPI_Sendrecv(u(0:nrl+1,1),nrl+2,MPI_DOUBLE_PRECISION,p_up,127,&
       u(0:nrl+1,nsl+1),nrl+2,MPI_DOUBLE_PRECISION,p_down,127,MPI_COMM_WORLD,status,ierr)
  ! send to the down recieve from the up
  call MPI_Sendrecv(u(0:nrl+1,nsl),nrl+2,MPI_DOUBLE_PRECISION,p_down,129,&
       u(0:nrl+1,0),nrl+2,MPI_DOUBLE_PRECISION,p_up,129,MPI_COMM_WORLD,status,ierr)
  call MPI_BARRIER(MPI_COMM_WORLD,ierr)
