program stronganalysis
  ...
  ! Compute the time to complete 1000 steps with a grid whose number of gridpoints is fixed.
  do n = 1,num_iterations
    start_time = MPI_Wtime()
    call timing(80,80,1.d0/dble(1000+1),1000,myid,nprocs,ierr)
    end_time = MPI_Wtime()
