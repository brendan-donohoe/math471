function positions = getbirdpositions(xmin, xmax, ymin, ymax, nbirds, cx, cy, gamma1, gamma2, kappa, ro, lambda, delta, h, endt, smellyRo)
  ...
  for i = 1:numiterations
    ...
    birdnext(2, 1) = rungekuttanext(@(t, y) smellyeqn(t, y, gamma2, birdcur(1,1), kappa, centerx), t, birdcur(2, 1), h);
    birdnext(2, 2) = rungekuttanext(@(t, y) smellyeqn(t, y, gamma2, birdcur(1,2), kappa, centery), t, birdcur(2, 2), h);
    ...
    for k = 3:nbirds
      ...
      % next position.
      birdnext(k, 1) = rungekuttanext(@(t, y) birdeqn(t, y, gamma2, birdcur(1, 1), kappa, centerx, ro, delta, nlist(nindices, 1), smellyRo, birdcur(2,1)), t, birdcur(k, 1), h);
      birdnext(k, 2) = rungekuttanext(@(t, y) birdeqn(t, y, gamma2, birdcur(1, 2), kappa, centery, ro, delta, nlist(nindices, 2), smellyRo, birdcur(2,2)), t, birdcur(k, 2), h);
    end
