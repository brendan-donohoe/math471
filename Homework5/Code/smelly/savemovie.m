function savemovie(xmin, xmax, ymin, ymax, nbirds, cx, cy, gamma1, gamma2, kappa, ro, lambda, delta, h, endt, filename, smellyRo)
  fprintf('Running simulation...\n');
  positions = getbirdpositions(xmin, xmax, ymin, ymax, nbirds, cx, cy, gamma1, gamma2, kappa, ro, lambda, delta, h, endt, smellyRo);
